...
type ConfigSearchReq struct {
	g.Meta     `path:"/config/list" tags:"系统后台/系统参数管理" method:"get" summary:"系统参数列表"`
...
type ConfigAddReq struct {
	g.Meta `path:"/config/add" tags:"系统后台/系统参数管理" method:"post" summary:"添加系统参数"`
	*ConfigReq
}
...
type ConfigGetReq struct {
	g.Meta `path:"/config/get" tags:"系统后台/系统参数管理" method:"get" summary:"获取系统参数"`
	Id     int `p:"id"`
}
...
type ConfigEditReq struct {
	g.Meta   `path:"/config/edit" tags:"系统后台/系统参数管理" method:"put" summary:"修改系统参数"`
...
type ConfigDeleteReq struct {
	g.Meta `path:"/config/delete" tags:"系统后台/系统参数管理" method:"delete" summary:"删除系统参数"`
	Ids    []int `p:"ids"`
}
...
type ConfigGetByKeyReq struct {
	g.Meta `path:"/config/getBykey" tags:"系统后台/系统参数管理" method:"get" summary:"按key获取系统参数"`
	commonApi.Author
	Key string `p:"key" v:"required#参数键名不能为空" dc:"参数键名"`
}
...
type ConfigGetBatchByKeyReq struct {
	g.Meta `path:"/config/getBatchBykey" tags:"系统后台/系统参数管理" method:"get" summary:"按key批量获取系统参数"`
	commonApi.Author
	Keys []string `p:"keys" v:"required#参数键名不能为空" dc:"参数键名"`
}

type ConfigGetBatchByKeyRes struct {
	g.Meta `mime:"application/json"`
	Data   []*commonEntity.SysConfig `json:"data"`
}

...
// SysAttachmentDao is the data access object for the table sys_attachment.
...
// SysAttachmentColumns defines and stores column names for the table sys_attachment.
...
// sysAttachmentColumns holds the columns for the table sys_attachment.

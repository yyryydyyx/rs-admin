...
func (s *sSysUser) GetAuthWhere(ctx context.Context, userInfo *model.ContextUser, url string, field ...string) g.Map {
	var (
		menuId uint
		err    error
		nm     g.Map
...
func (s *sSysUser) GetAuthDeptWhere(ctx context.Context, userInfo *model.ContextUser, url string, field ...string) g.Map {
	var (
		menuId uint
		err    error
		nm     g.Map

...
type (
	IToolsGenTableColumn interface {
		SelectDbTableColumnsByName(ctx context.Context, tableName string, group string) ([]*entity.ToolsGenTableColumn, error)
		...
		SelectDbTableColumnMapByName(ctx context.Context, tableName string, group string) (res map[string]*entity.ToolsGenTableColumn, err error)
	}
)

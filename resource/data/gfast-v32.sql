...
CREATE TABLE `emp_attendance`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '考勤ID',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_employee_date`(`employee_id`, `attendance_date`) USING BTREE
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '附件管理' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_attachment
-- ----------------------------
INSERT INTO `sys_attachment` VALUES (2, 'system', '0', 'a222.jpg', 'image', 'image/jpeg', 'upload_file/2024-11-18/d5p41p66q7fctdzicz.jpg', 25947, 'jpg', 'f4378e34be8f7a6c311ad068b3498405', 31, 1, '2024-11-18 15:02:39', '2025-09-18 11:44:23');
INSERT INTO `sys_attachment` VALUES (3, 'system', '0', 'a111.jpg', 'image', 'application/octet-stream', 'upload_file/2024-11-18/d5p41ssy6gg4beecej.jpg', 104079, 'jpg', '11c14ce4809ff610e44b1da373500703', 31, 1, '2024-11-18 15:02:47', '2025-09-18 11:44:23');
INSERT INTO `sys_attachment` VALUES (5, 'system', '0', 'a333.jpg', 'image', 'image/jpeg', 'upload_file/2025-09-17/dcupcr6y2gqwe3xg0v.jpg', 18381, 'jpg', 'b1f4daf376347c18666c4670325cebd7', 31, 1, '2025-09-17 09:59:37', '2025-09-30 15:16:46');
INSERT INTO `sys_attachment` VALUES (6, 'system', '0', '74595d93db72bc45e5f5161ca35f5995.jpg', 'image', 'image/jpeg', 'upload_file/2025-09-18/dcvl3gavex4w69dm1o.jpg', 62462, 'jpg', '526b0b65be9c2921a7c8927b40663bec', 31, 1, '2025-09-18 10:52:04', '2025-09-18 10:52:15');
INSERT INTO `sys_attachment` VALUES (7, 'system', '0', '65ba709137c044a7b72a7f381ab91d7f.jpg', 'image', 'image/jpeg', 'upload_file/2025-09-18/dcvl3gavf48gwsggay.jpg', 329786, 'jpg', '6ac18a4cb86df80649ffd51cd29f3532', 31, 1, '2025-09-18 10:52:04', '2025-09-18 14:49:34');
INSERT INTO `sys_attachment` VALUES (8, 'system', '0', '5b5fd982ce018.jpg', 'image', 'image/jpeg', 'upload_file/2025-09-18/dcvl3gavf48gvkjx7x.jpg', 84889, 'jpg', 'a028a7a77aaa52fdd9653bb23c3b37eb', 31, 1, '2025-09-18 10:52:04', '2025-09-18 14:49:34');
INSERT INTO `sys_attachment` VALUES (9, 'system', '0', '00300281425_2fbbb18b.jpg', 'image', 'image/jpeg', 'upload_file/2025-09-18/dcvl8foye7ecja3fvz.jpg', 87448, 'jpg', '045adbb5b9af4157acc8b2f8fa05f8d6', 31, 1, '2025-09-18 10:58:34', '2025-09-18 11:44:23');
INSERT INTO `sys_attachment` VALUES (10, 'system', '0', '65d3d7ad866394bf86309af1bbba11a3.jpeg', 'image', 'image/jpeg', 'upload_file/2025-09-30/dd5ycpy86l18yxxpgf.jpeg', 102522, 'jpeg', 'ed911dfb50660455dd4802cb98cd14d7', 31, 1, '2025-09-30 15:22:04', '2025-09-30 15:22:04');
...
CREATE TABLE `sys_job_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1253 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '任务日志表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_notice`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '通知公告' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '已读记录' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '操作日志记录' ROW_FORMAT = COMPACT;
...
INSERT INTO `sys_user` VALUES (31, 'demo', '15334455789', '李四', 0, '6dd68eea81e0fca319add0bd58c3fdf6', '46PvWe1Sl7', 1, '123@qq.com', 2, 'upload_file/2024-07-29/d31lsrb6o3rgmrdiih.jpg', 109, '3', 1, '云南省曲靖市22223', '生活变的再糟糕，也不妨碍我变得更好', '::1', '2025-11-05 11:31:39', '2021-06-22 17:58:00', '2024-07-29 08:41:22', NULL, '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户在线状态表' ROW_FORMAT = COMPACT;

-- ----------------------------
-- Records of sys_user_online
-- ----------------------------
INSERT INTO `sys_user_online` VALUES (7, '037b28d52bfbc6052a3680b7a64954e2', '7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO0WeV4pHu1ZnvGj5kxWfLrbsTDhymIPEZv0k5LhAdPcmh1yV/LtV81rZth5wZM8hP+UH923jq3lRTW+kCsLRLTuNRNv9mC1fbYA3lkijlRQ+Q==', '2025-11-05 11:31:39', 'demo', '::1', 'Chrome', 'Windows 10');
...
CREATE TABLE `tools_gen_table`  (
  ...
  `group` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '数据库group',

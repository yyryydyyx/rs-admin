...
CREATE TABLE `demo_city_code`  (
  ...
  UNIQUE INDEX `id，name,code`(`id` ASC, `name` ASC, `weathercode` ASC) USING BTREE COMMENT '这三个字段并列一起，必须是唯一的'
...
CREATE TABLE `demo_gen`  (
  ...
  `cate_trees` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '树型单选',
...
CREATE TABLE `demo_gen_class`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '代码生成关联测试表' ROW_FORMAT = COMPACT;
...
INSERT INTO `demo_gen_class` VALUES (7, '分类四');
...
CREATE TABLE `demo_gen_tree`  (
  ...
  `demo_status` tinyint NOT NULL DEFAULT 0 COMMENT '状态',
  `demo_cate` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '分类',
  `user_id` bigint UNSIGNED NOT NULL DEFAULT 0 COMMENT '关联人',
  `user_ids` json NULL COMMENT '关联人信息',
  `depart_id` bigint UNSIGNED NOT NULL DEFAULT 0 COMMENT '关联部门',
...
INSERT INTO `demo_gen_tree` VALUES (3, 0, '王五', 63, '5', '2021-08-17 00:00:00', 1, '2021-08-04 11:54:56', '2025-08-14 15:17:00', NULL, 31, 3, 1, '0', 0, '[]', 0, '[]');
...
INSERT INTO `demo_snow_id` VALUES (709794007588274177, '李四', 40, '', '[]', '[]', '[]', '[]', 1, '[3, 4, 6]', 103, '[104, 105]');
...
CREATE TABLE `emp_attendance`  (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '考勤ID',
  ...
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '考勤状态(1正常 2迟到 3早退 4缺勤 5请假)',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_employee_date`(`employee_id` ASC, `attendance_date` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '员工考勤记录表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of emp_attendance
-- ----------------------------
INSERT INTO `emp_attendance` VALUES (1, 1, '2025-09-30', '2025-09-30 15:26:23', '2025-09-30 15:26:24', 1, '', '', '', '2025-09-30 15:26:26', '2025-09-30 15:26:26');
...
CREATE TABLE `emp_department`  (
  ...
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '员工部门表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of emp_department
-- ----------------------------
INSERT INTO `emp_department` VALUES (1, '部门1', 0, 0, '', '', '', 1, '', NULL, '', NULL, '');
INSERT INTO `emp_department` VALUES (2, '部门2', 1, 0, '', '', '', 1, '', NULL, '', NULL, '');

-- ----------------------------
-- Table structure for emp_employee
-- ----------------------------
...
-- ----------------------------
-- Records of emp_employee
-- ----------------------------
INSERT INTO `emp_employee` VALUES (1, '张三', 1, 'upload_file/2025-09-17/dcupcr6y2gqwe3xg0v.jpg', 1, '', '2025-09-30', '13855566668', '', '', 1, '', '', '', '2025-09-30 15:16:18', '2025-09-30 15:16:47');
INSERT INTO `emp_employee` VALUES (2, '李四', 1, 'upload_file/2025-09-30/dd5ycpy86l18yxxpgf.jpeg', 1, '', NULL, '', '', '', 1, '', '', '', '2025-09-30 15:22:11', '2025-09-30 15:22:11');
...
CREATE TABLE `sys_attachment`  (
  ...
  `created_by` bigint NULL DEFAULT 0 COMMENT '上传人ID',
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '状态',
  `created_at` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `updated_at` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `md5`(`md5` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '附件管理' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_attachment
-- ----------------------------
INSERT INTO `sys_attachment` VALUES (2, 'system', '0', 'a222.jpg', 'image', 'image/jpeg', 'upload_file/2024-11-18/d5p41p66q7fctdzicz.jpg', NULL, 25947, 'jpg', 'f4378e34be8f7a6c311ad068b3498405', 31, 1, '2024-11-18 15:02:39', '2025-09-18 11:44:23');
INSERT INTO `sys_attachment` VALUES (3, 'system', '0', 'a111.jpg', 'image', 'application/octet-stream', 'upload_file/2024-11-18/d5p41ssy6gg4beecej.jpg', NULL, 104079, 'jpg', '11c14ce4809ff610e44b1da373500703', 31, 1, '2024-11-18 15:02:47', '2025-09-18 11:44:23');
INSERT INTO `sys_attachment` VALUES (5, 'system', '0', 'a333.jpg', 'image', 'image/jpeg', 'upload_file/2025-09-17/dcupcr6y2gqwe3xg0v.jpg', NULL, 18381, 'jpg', 'b1f4daf376347c18666c4670325cebd7', 31, 1, '2025-09-17 09:59:37', '2025-09-30 15:16:46');
INSERT INTO `sys_attachment` VALUES (6, 'system', '0', '74595d93db72bc45e5f5161ca35f5995.jpg', 'image', 'image/jpeg', 'upload_file/2025-09-18/dcvl3gavex4w69dm1o.jpg', NULL, 62462, 'jpg', '526b0b65be9c2921a7c8927b40663bec', 31, 1, '2025-09-18 10:52:04', '2025-09-18 10:52:15');
INSERT INTO `sys_attachment` VALUES (7, 'system', '0', '65ba709137c044a7b72a7f381ab91d7f.jpg', 'image', 'image/jpeg', 'upload_file/2025-09-18/dcvl3gavf48gwsggay.jpg', NULL, 329786, 'jpg', '6ac18a4cb86df80649ffd51cd29f3532', 31, 1, '2025-09-18 10:52:04', '2025-09-18 14:49:34');
INSERT INTO `sys_attachment` VALUES (8, 'system', '0', '5b5fd982ce018.jpg', 'image', 'image/jpeg', 'upload_file/2025-09-18/dcvl3gavf48gvkjx7x.jpg', NULL, 84889, 'jpg', 'a028a7a77aaa52fdd9653bb23c3b37eb', 31, 1, '2025-09-18 10:52:04', '2025-09-18 14:49:34');
INSERT INTO `sys_attachment` VALUES (9, 'system', '0', '00300281425_2fbbb18b.jpg', 'image', 'image/jpeg', 'upload_file/2025-09-18/dcvl8foye7ecja3fvz.jpg', NULL, 87448, 'jpg', '045adbb5b9af4157acc8b2f8fa05f8d6', 31, 1, '2025-09-18 10:58:34', '2025-09-18 11:44:23');
INSERT INTO `sys_attachment` VALUES (10, 'system', '0', '65d3d7ad866394bf86309af1bbba11a3.jpeg', 'image', 'image/jpeg', 'upload_file/2025-09-30/dd5ycpy86l18yxxpgf.jpeg', NULL, 102522, 'jpeg', 'ed911dfb50660455dd4802cb98cd14d7', 31, 1, '2025-09-30 15:22:04', '2025-09-30 15:22:04');
INSERT INTO `sys_attachment` VALUES (11, 'system', '0', 'co9copop81co0gysbz.jpg', 'image', 'image/jpeg', 'upload_file/2026-05-04/di9y2j0don2xzz9jtb.jpg', NULL, 34277, 'jpg', '4368a7f82d64330d11cf07c9a90ed8e4', 31, 1, '2026-05-04 21:59:17', '2026-05-04 22:13:42');
...
) ENGINE = InnoDB AUTO_INCREMENT = 146 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '菜单节点表' ROW_FORMAT = COMPACT;
...
INSERT INTO `sys_auth_rule` VALUES (145, 26, 'api/v1/system/user/resetPwd', '重置密码', '', '', '', 2, 0, 0, '', '', 0, '', 0, 0, 1, '', 0, '', '2025-10-27 16:01:32', '2025-10-27 16:01:32');
...
) ENGINE = InnoDB AUTO_INCREMENT = 180 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '字典数据表' ROW_FORMAT = COMPACT;

-- ----------------------------
-- Records of sys_dict_data
-- ----------------------------
INSERT INTO `sys_dict_data` VALUES (1, 0, '男', '1', 'sys_user_sex', '', '', 0, 1, 31, 2, '备注信息', '2022-04-18 16:46:22', '2025-06-06 16:08:23');
INSERT INTO `sys_dict_data` VALUES (2, 0, '女', '2', 'sys_user_sex', '', '', 0, 1, 31, 31, '备注信息', NULL, '2025-06-06 16:08:23');
INSERT INTO `sys_dict_data` VALUES (3, 0, '保密', '0', 'sys_user_sex', '', '', 1, 1, 31, 31, '备注信息', NULL, '2025-06-06 16:08:23');
...
INSERT INTO `sys_dict_data` VALUES (32, 0, '成功', '1', 'admin_login_status', '', 'default', 0, 1, 31, 31, '', NULL, '2025-06-09 08:59:59');
INSERT INTO `sys_dict_data` VALUES (33, 0, '失败', '0', 'admin_login_status', '', 'default', 0, 1, 31, 0, '', NULL, '2025-06-09 08:59:59');
...
INSERT INTO `sys_dict_data` VALUES (62, 0, '系统后台', 'sys_admin', 'menu_module_type', '', '', 1, 1, 2, 0, '', NULL, '2025-06-09 11:04:59');
INSERT INTO `sys_dict_data` VALUES (63, 0, '政务工作', 'gov_work', 'menu_module_type', '', '', 0, 1, 2, 0, '', NULL, '2025-06-09 11:04:59');
INSERT INTO `sys_dict_data` VALUES (64, 0, '幻灯', '3', 'cms_article_attr', '', '', 0, 1, 31, 0, '', NULL, NULL);
INSERT INTO `sys_dict_data` VALUES (65, 0, '[work]测试业务表', 'wf_news', 'flow_type', '', '', 0, 1, 2, 2, '', NULL, '2025-09-08 16:39:34');
INSERT INTO `sys_dict_data` VALUES (66, 0, '回退修改', '-1', 'flow_status', '', '', 0, 1, 31, 0, '', NULL, '2025-06-09 11:04:16');
INSERT INTO `sys_dict_data` VALUES (67, 0, '保存中', '0', 'flow_status', '', '', 0, 1, 31, 0, '', NULL, '2025-06-09 11:04:16');
INSERT INTO `sys_dict_data` VALUES (68, 0, '流程中', '1', 'flow_status', '', '', 0, 1, 31, 0, '', NULL, '2025-06-09 11:04:16');
INSERT INTO `sys_dict_data` VALUES (69, 0, '审批通过', '2', 'flow_status', '', '', 0, 1, 31, 2, '', NULL, '2025-06-09 11:04:16');
...
INSERT INTO `sys_dict_data` VALUES (78, 0, '普通', '0', 'flow_level', '', '', 0, 1, 31, 0, '', NULL, '2025-06-09 11:04:27');
INSERT INTO `sys_dict_data` VALUES (79, 0, '加急', '1', 'flow_level', '', '', 0, 1, 31, 0, '', NULL, '2025-06-09 11:04:27');
INSERT INTO `sys_dict_data` VALUES (80, 0, '紧急', '2', 'flow_level', '', '', 0, 1, 31, 0, '', NULL, '2025-06-09 11:04:27');
INSERT INTO `sys_dict_data` VALUES (81, 0, '特急', '3', 'flow_level', '', '', 0, 1, 31, 31, '', NULL, '2025-06-09 11:04:27');
...
INSERT INTO `sys_dict_data` VALUES (87, 0, '[cms]文章表', 'cms_news', 'flow_type', '', '', 0, 1, 31, 0, '', NULL, '2025-09-08 16:39:34');
...
INSERT INTO `sys_dict_data` VALUES (106, 0, '无标签', '0', 'notice_tag', '', '', 0, 1, 31, 31, '', '2023-12-28 15:48:45', '2025-06-09 11:04:35');
INSERT INTO `sys_dict_data` VALUES (107, 0, '提醒', '1', 'notice_tag', '', '', 0, 1, 31, 31, '', '2023-12-28 15:48:54', '2025-06-09 11:04:35');
INSERT INTO `sys_dict_data` VALUES (108, 0, '一般', '2', 'notice_tag', '', '', 0, 1, 31, 0, '', '2023-12-28 15:52:35', '2025-06-09 11:04:35');
INSERT INTO `sys_dict_data` VALUES (109, 0, '次要', '3', 'notice_tag', '', '', 0, 1, 31, 0, '', '2023-12-28 15:52:44', '2025-06-09 11:04:35');
INSERT INTO `sys_dict_data` VALUES (110, 0, '重要', '4', 'notice_tag', '', '', 0, 1, 31, 0, '', '2023-12-28 15:52:53', '2025-06-09 11:04:35');
INSERT INTO `sys_dict_data` VALUES (111, 0, '紧急', '5', 'notice_tag', '', '', 0, 1, 31, 0, '', '2023-12-28 15:53:01', '2025-06-09 11:04:35');
...
INSERT INTO `sys_dict_data` VALUES (152, 0, '事假', '1', 'emp_leave_type', '', '', 0, 1, 0, 0, '事假', '2025-09-11 16:59:13', '2025-09-11 16:59:13');
INSERT INTO `sys_dict_data` VALUES (153, 0, '病假', '2', 'emp_leave_type', '', '', 0, 1, 0, 0, '病假', '2025-09-11 16:59:13', '2025-09-11 16:59:13');
INSERT INTO `sys_dict_data` VALUES (154, 0, '年假', '3', 'emp_leave_type', '', '', 0, 1, 0, 0, '年假', '2025-09-11 16:59:13', '2025-09-11 16:59:13');
INSERT INTO `sys_dict_data` VALUES (155, 0, '调休', '4', 'emp_leave_type', '', '', 0, 1, 0, 0, '调休', '2025-09-11 16:59:13', '2025-09-11 16:59:13');
INSERT INTO `sys_dict_data` VALUES (165, 0, '男', '1', 'emp_gender', '', '', 0, 1, 0, 0, '男性', '2025-09-12 16:43:46', '2025-09-12 16:43:46');
INSERT INTO `sys_dict_data` VALUES (166, 0, '女', '2', 'emp_gender', '', '', 0, 1, 0, 0, '女性', '2025-09-12 16:43:46', '2025-09-12 16:43:46');
INSERT INTO `sys_dict_data` VALUES (167, 0, '在职', '1', 'emp_status', '', '', 0, 1, 0, 0, '在职状态', '2025-09-12 16:44:05', '2025-09-12 16:44:05');
INSERT INTO `sys_dict_data` VALUES (168, 0, '离职', '2', 'emp_status', '', '', 0, 1, 0, 0, '离职状态', '2025-09-12 16:44:05', '2025-09-12 16:44:05');
INSERT INTO `sys_dict_data` VALUES (169, 0, '休假', '3', 'emp_status', '', '', 0, 1, 0, 0, '休假状态', '2025-09-12 16:44:05', '2025-09-12 16:44:05');
INSERT INTO `sys_dict_data` VALUES (175, 0, '正常', '1', 'emp_attendance_status', '', '', 0, 1, 0, 0, '正常考勤', '2025-09-30 15:24:18', '2025-09-30 15:24:18');
INSERT INTO `sys_dict_data` VALUES (176, 0, '迟到', '2', 'emp_attendance_status', '', '', 0, 1, 0, 0, '迟到', '2025-09-30 15:24:18', '2025-09-30 15:24:18');
INSERT INTO `sys_dict_data` VALUES (177, 0, '早退', '3', 'emp_attendance_status', '', '', 0, 1, 0, 0, '早退', '2025-09-30 15:24:18', '2025-09-30 15:24:18');
INSERT INTO `sys_dict_data` VALUES (178, 0, '无效打卡', '4', 'emp_attendance_status', '', '', 0, 1, 0, 0, '无效打卡', '2025-09-30 15:24:18', '2025-09-30 15:24:18');
INSERT INTO `sys_dict_data` VALUES (179, 0, '无打卡', '5', 'emp_attendance_status', '', '', 0, 1, 0, 0, '无打卡', '2025-09-30 15:24:18', '2025-09-30 15:24:18');
...
) ENGINE = InnoDB AUTO_INCREMENT = 80 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '字典类型表' ROW_FORMAT = COMPACT;

-- ----------------------------
-- Records of sys_dict_type
-- ----------------------------
INSERT INTO `sys_dict_type` VALUES (1, 54, '用户性别', 'sys_user_sex', 1, 31, 31, '用于选择用户性别', NULL, '2025-06-06 16:08:23');
INSERT INTO `sys_dict_type` VALUES (2, 55, '分类类型', 'cms_category_type', 1, 31, 3, '文章分类类型', NULL, '2021-07-21 10:54:22');
INSERT INTO `sys_dict_type` VALUES (3, 54, '任务状态', 'sys_job_status', 1, 31, 31, '任务状态列表', NULL, NULL);
INSERT INTO `sys_dict_type` VALUES (13, 54, '任务分组', 'sys_job_group', 1, 31, 0, '', NULL, NULL);
INSERT INTO `sys_dict_type` VALUES (14, 54, '管理员登录状态', 'admin_login_status', 1, 31, 31, '', NULL, '2025-06-09 08:59:59');
INSERT INTO `sys_dict_type` VALUES (15, 54, '操作日志状态', 'sys_oper_log_status', 1, 31, 0, '', NULL, NULL);
INSERT INTO `sys_dict_type` VALUES (16, 54, '任务策略', 'sys_job_policy', 1, 31, 0, '', NULL, NULL);
INSERT INTO `sys_dict_type` VALUES (17, 54, '菜单状态', 'sys_show_hide', 1, 31, 0, '菜单状态', NULL, NULL);
INSERT INTO `sys_dict_type` VALUES (18, 54, '系统开关', 'sys_normal_disable', 1, 31, 31, '系统开关', NULL, NULL);
INSERT INTO `sys_dict_type` VALUES (24, 54, '系统内置', 'sys_yes_no', 1, 31, 0, '', NULL, NULL);
INSERT INTO `sys_dict_type` VALUES (25, 55, '文章发布状态', 'cms_article_pub_type', 1, 31, 0, '', NULL, NULL);
INSERT INTO `sys_dict_type` VALUES (26, 55, '文章附加状态', 'cms_article_attr', 1, 31, 0, '', NULL, NULL);
INSERT INTO `sys_dict_type` VALUES (27, 55, '文章类型', 'cms_article_type', 1, 31, 0, '', NULL, NULL);
INSERT INTO `sys_dict_type` VALUES (28, 55, '文章栏目模型分类', 'cms_cate_models', 1, 1, 0, '', NULL, NULL);
INSERT INTO `sys_dict_type` VALUES (30, 54, '菜单模块类型', 'menu_module_type', 1, 2, 31, '', NULL, '2025-06-09 11:04:59');
INSERT INTO `sys_dict_type` VALUES (31, 56, '工作流程类型', 'flow_type', 1, 2, 31, '', NULL, '2025-09-08 16:39:34');
INSERT INTO `sys_dict_type` VALUES (32, 56, '工作流程审批状态', 'flow_status', 1, 31, 31, '工作流程审批状态', NULL, '2025-06-09 11:04:16');
INSERT INTO `sys_dict_type` VALUES (33, 54, '博客分类类型', 'sys_blog_type', 1, 31, 31, '博客分类中的标志', NULL, NULL);
INSERT INTO `sys_dict_type` VALUES (34, 54, '博客日志标志', 'sys_log_sign', 1, 31, 0, '博客日志管理中的标志数据字典', NULL, NULL);
INSERT INTO `sys_dict_type` VALUES (35, 56, '工作流紧急状态', 'flow_level', 1, 31, 31, '', NULL, '2025-06-09 11:04:27');
INSERT INTO `sys_dict_type` VALUES (49, 55, 'CMS栏目导航位置', 'cms_nav_position', 1, 22, 0, '', '2021-08-31 15:37:04', '2021-08-31 15:37:04');
INSERT INTO `sys_dict_type` VALUES (50, 54, '操作日志类型', 'sys_oper_log_type', 1, 31, 0, '', '2022-12-21 11:55:02', '2022-12-21 11:55:02');
INSERT INTO `sys_dict_type` VALUES (51, 54, '系统公告标签', 'notice_tag', 1, 31, 31, '', '2023-12-28 15:48:03', '2025-06-09 11:04:35');
INSERT INTO `sys_dict_type` VALUES (52, 54, '附件上传驱动', 'sys_upload_drive', 1, 31, 31, '', '2024-10-23 14:36:17', '2024-10-23 14:36:30');
INSERT INTO `sys_dict_type` VALUES (53, 54, '上传文件类型', 'sys_upload_file_type', 1, 31, 0, '', '2024-10-23 14:53:50', '2024-10-23 14:53:50');
...
INSERT INTO `sys_dict_type` VALUES (76, 0, '员工性别', 'emp_gender', 1, 0, 0, '员工性别字典', '2025-09-12 16:39:17', '2025-09-12 16:39:17');
INSERT INTO `sys_dict_type` VALUES (77, 0, '员工状态', 'emp_status', 1, 0, 0, '员工在职状态字典', '2025-09-12 16:39:31', '2025-09-12 16:39:31');
INSERT INTO `sys_dict_type` VALUES (79, 0, '考勤状态', 'emp_attendance_status', 1, 0, 0, '员工考勤状态字典', '2025-09-30 15:24:09', '2025-09-30 15:24:09');
...
CREATE TABLE `sys_job`  (
  ...
  UNIQUE INDEX `invoke_target`(`invoke_target` ASC) USING BTREE
...
-- ----------------------------
INSERT INTO `sys_job_log` VALUES (1253, 'checkUserOnline', '2026-05-02 21:50:06', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1254, 'checkUserOnline', '2026-05-02 22:00:05', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1255, 'checkUserOnline', '2026-05-02 22:10:05', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1256, 'checkUserOnline', '2026-05-02 22:30:05', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1257, 'checkUserOnline', '2026-05-02 22:40:05', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1258, 'checkUserOnline', '2026-05-02 22:50:05', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1259, 'checkUserOnline', '2026-05-02 23:00:05', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1260, 'checkUserOnline', '2026-05-02 23:10:06', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1261, 'checkUserOnline', '2026-05-02 23:20:05', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1262, 'checkUserOnline', '2026-05-02 23:30:05', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1263, 'checkUserOnline', '2026-05-02 23:40:06', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1264, 'checkUserOnline', '2026-05-02 23:50:05', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1265, 'checkUserOnline', '2026-05-03 00:00:06', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1266, 'checkUserOnline', '2026-05-03 00:10:05', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1267, 'checkUserOnline', '2026-05-03 22:00:06', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1268, 'checkUserOnline', '2026-05-03 22:10:06', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1269, 'checkUserOnline', '2026-05-03 22:20:06', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1270, 'checkUserOnline', '2026-05-03 22:30:06', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1271, 'checkUserOnline', '2026-05-04 21:30:06', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1272, 'checkUserOnline', '2026-05-04 21:40:06', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1273, 'checkUserOnline', '2026-05-04 21:50:05', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1274, 'checkUserOnline', '2026-05-04 22:00:05', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1275, 'checkUserOnline', '2026-05-04 22:10:05', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1276, 'checkUserOnline', '2026-05-04 22:20:05', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1277, 'checkUserOnline', '2026-05-04 22:30:05', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1278, 'checkUserOnline', '2026-05-04 22:40:05', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1279, 'checkUserOnline', '2026-05-04 22:50:05', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1280, 'checkUserOnline', '2026-05-04 23:00:05', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1281, 'checkUserOnline', '2026-05-04 23:10:05', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1282, 'checkUserOnline', '2026-05-04 23:20:05', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1283, 'checkUserOnline', '2026-05-04 23:30:05', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1284, 'checkUserOnline', '2026-05-04 23:40:05', '在线用户定时更新，执行成功');
INSERT INTO `sys_job_log` VALUES (1285, 'checkUserOnline', '2026-05-04 23:50:05', '在线用户定时更新，执行成功');
...
-- ----------------------------
INSERT INTO `sys_login_log` VALUES (1, 'demo', '20.0.0.1', '', 'Chrome', 'Windows 10', 1, '登录成功', '2026-05-02 21:45:06', '系统后台');
...
CREATE TABLE `sys_notice`  (
  ...
  `tag` int NULL DEFAULT NULL COMMENT '标签',
  `content` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '内容',
  `remark` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `sort` int NOT NULL DEFAULT 0 COMMENT '排序',
  `status` tinyint(1) NULL DEFAULT 1 COMMENT '状态',
  `created_by` bigint NULL DEFAULT NULL COMMENT '发送人',
  `updated_by` bigint NULL DEFAULT 0 COMMENT '修改人',
  `created_at` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `updated_at` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `deleted_at` datetime NULL DEFAULT NULL COMMENT '删除时间',
  `receiver` json NULL COMMENT '接收者（私信）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '通知公告' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_notice
-- ----------------------------
INSERT INTO `sys_notice` VALUES (1, '测试001', 1, 2, '<p>666666666</p>', '', 0, 1, 31, 31, '2024-01-02 17:46:59', '2025-10-27 16:20:44', NULL, NULL);
INSERT INTO `sys_notice` VALUES (2, '测试私信', 2, 3, '<p>888888888888</p>', '', 0, 1, 31, 31, '2024-01-02 17:47:36', '2025-06-12 08:59:51', NULL, '[2, 3, 31]');
INSERT INTO `sys_notice` VALUES (6, 'demo', 2, 2, '<p>888</p>', '', 0, 1, 31, 31, '2025-06-12 09:00:32', '2025-10-27 16:18:01', NULL, '[31]');
INSERT INTO `sys_notice` VALUES (7, 'aaa', 1, 0, '<p>dddddd</p>', '', 0, 1, 31, 31, '2025-08-15 15:37:39', '2025-10-27 16:17:51', NULL, NULL);
...
CREATE TABLE `sys_notice_read`  (
  ...
  `clicks` int NULL DEFAULT NULL COMMENT '点击次数',
  `updated_at` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `created_at` datetime NULL DEFAULT NULL COMMENT '阅读时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `notice_id`(`notice_id` ASC, `user_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '已读记录' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_notice_read
-- ----------------------------
INSERT INTO `sys_notice_read` VALUES (1, 1, 31, 0, '2024-01-02 17:47:05', '2024-01-02 17:47:05');
INSERT INTO `sys_notice_read` VALUES (2, 2, 31, 0, '2025-06-12 09:45:15', '2025-06-12 09:45:15');
INSERT INTO `sys_notice_read` VALUES (3, 7, 31, 0, '2025-09-11 11:45:56', '2025-09-11 11:45:56');
INSERT INTO `sys_notice_read` VALUES (4, 6, 31, 0, '2026-05-02 21:47:14', '2026-05-02 21:47:14');
...
-- ----------------------------
INSERT INTO `sys_oper_log` VALUES (1, '', 0, '/api/v1/system/operLog/clear', 'DELETE', 1, 'demo', '财务部门', '/api/v1/system/operLog/clear', '::1', '内网IP', '{}', NULL, '2025-11-05 11:36:14');
INSERT INTO `sys_oper_log` VALUES (2, '操作日志', 0, '/api/v1/system/operLog/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/operLog/list?pageNum=1&pageSize=10', '::1', '内网IP', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2025-11-05 11:36:14');
INSERT INTO `sys_oper_log` VALUES (3, '在线用户', 0, '/api/v1/system/online/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/online/list?ipaddr=&userName=&pageNum=1&pageSize=10', '::1', '内网IP', '{\"ipaddr\":\"\",\"pageNum\":\"1\",\"pageSize\":\"10\",\"userName\":\"\"}', NULL, '2025-11-05 11:36:17');
INSERT INTO `sys_oper_log` VALUES (4, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_job_group&defaultValue=', '::1', '内网IP', '{\"defaultValue\":\"\",\"dictType\":\"sys_job_group\"}', NULL, '2025-11-05 11:36:22');
INSERT INTO `sys_oper_log` VALUES (5, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_job_status&defaultValue=', '::1', '内网IP', '{\"defaultValue\":\"\",\"dictType\":\"sys_job_status\"}', NULL, '2025-11-05 11:36:22');
INSERT INTO `sys_oper_log` VALUES (6, '定时任务', 0, '/api/v1/system/sysJob/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysJob/list?pageNum=1&pageSize=10', '::1', '内网IP', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2025-11-05 11:36:22');
INSERT INTO `sys_oper_log` VALUES (7, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_job_policy&defaultValue=', '::1', '内网IP', '{\"defaultValue\":\"\",\"dictType\":\"sys_job_policy\"}', NULL, '2025-11-05 11:36:22');
INSERT INTO `sys_oper_log` VALUES (8, '定时任务查询', 0, '/api/v1/system/sysJob/get', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysJob/get?jobId=8', '::1', '内网IP', '{\"jobId\":\"8\"}', NULL, '2025-11-05 11:36:23');
INSERT INTO `sys_oper_log` VALUES (9, '', 0, '/api/v1/system/sysJob/logs', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysJob/logs?pageNum=1&pageSize=10&targetName=checkUserOnline', '::1', '内网IP', '{\"pageNum\":\"1\",\"pageSize\":\"10\",\"targetName\":\"checkUserOnline\"}', NULL, '2025-11-05 11:36:23');
INSERT INTO `sys_oper_log` VALUES (10, '', 0, '/api/v1/system/sysJob/deleteLogs', 'DELETE', 1, 'demo', '财务部门', '/api/v1/system/sysJob/deleteLogs', '::1', '内网IP', '{\"targetName\":\"checkUserOnline\"}', NULL, '2025-11-05 11:36:26');
INSERT INTO `sys_oper_log` VALUES (11, '', 0, '/api/v1/system/sysJob/logs', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysJob/logs?pageNum=1&pageSize=10&targetName=checkUserOnline', '::1', '内网IP', '{\"pageNum\":\"1\",\"pageSize\":\"10\",\"targetName\":\"checkUserOnline\"}', NULL, '2025-11-05 11:36:26');
INSERT INTO `sys_oper_log` VALUES (12, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '::1', '内网IP', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2025-11-05 11:36:32');
INSERT INTO `sys_oper_log` VALUES (13, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '::1', '内网IP', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2025-11-05 11:36:32');
INSERT INTO `sys_oper_log` VALUES (14, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '::1', '内网IP', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2025-11-05 11:36:32');
INSERT INTO `sys_oper_log` VALUES (15, '', 0, '/api/v1/system/dict/type/optionSelect', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/type/optionSelect?all=true', '20.0.0.1', '', '{\"all\":\"true\"}', NULL, '2026-05-02 21:45:47');
INSERT INTO `sys_oper_log` VALUES (16, '', 0, '/api/v1/system/dict/data/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/list?pageNum=1&pageSize=20&dictLabel=&status=', '20.0.0.1', '', '{\"dictLabel\":\"\",\"pageNum\":\"1\",\"pageSize\":\"20\",\"status\":\"\"}', NULL, '2026-05-02 21:45:47');
INSERT INTO `sys_oper_log` VALUES (17, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 21:46:14');
INSERT INTO `sys_oper_log` VALUES (18, '', 0, '/api/v1/system/sysNotice/listShow', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysNotice/listShow?pageNum=1&pageSize=10&type=1&isTrim=true', '20.0.0.1', '', '{\"isTrim\":\"true\",\"pageNum\":\"1\",\"pageSize\":\"10\",\"type\":\"1\"}', NULL, '2026-05-02 21:47:06');
INSERT INTO `sys_oper_log` VALUES (19, '', 0, '/api/v1/system/sysNotice/unReadCount', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysNotice/unReadCount', '20.0.0.1', '', '{}', NULL, '2026-05-02 21:47:06');
INSERT INTO `sys_oper_log` VALUES (20, '', 0, '/api/v1/system/sysNotice/listShow', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysNotice/listShow?pageNum=1&pageSize=10&type=2&isTrim=true', '20.0.0.1', '', '{\"isTrim\":\"true\",\"pageNum\":\"1\",\"pageSize\":\"10\",\"type\":\"2\"}', NULL, '2026-05-02 21:47:08');
INSERT INTO `sys_oper_log` VALUES (21, '', 0, '/api/v1/system/sysNoticeRead/readNotice', 'POST', 1, 'demo', '财务部门', '/api/v1/system/sysNoticeRead/readNotice', '20.0.0.1', '', '{\"noticeId\":6}', NULL, '2026-05-02 21:47:14');
INSERT INTO `sys_oper_log` VALUES (22, '', 0, '/api/v1/system/sysNotice/unReadCount', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysNotice/unReadCount', '20.0.0.1', '', '{}', NULL, '2026-05-02 21:47:14');
INSERT INTO `sys_oper_log` VALUES (23, '', 0, '/api/v1/system/sysNotice/listShow', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysNotice/listShow?pageNum=1&pageSize=10&type=2&isTrim=true', '20.0.0.1', '', '{\"isTrim\":\"true\",\"pageNum\":\"1\",\"pageSize\":\"10\",\"type\":\"2\"}', NULL, '2026-05-02 21:47:14');
INSERT INTO `sys_oper_log` VALUES (24, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:29:48');
INSERT INTO `sys_oper_log` VALUES (25, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:32:56');
INSERT INTO `sys_oper_log` VALUES (26, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:33:20');
INSERT INTO `sys_oper_log` VALUES (27, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:33:33');
INSERT INTO `sys_oper_log` VALUES (28, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:34:02');
INSERT INTO `sys_oper_log` VALUES (29, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:38:50');
INSERT INTO `sys_oper_log` VALUES (30, '', 0, '/api/v1/system/cache/remove', 'DELETE', 1, 'demo', '财务部门', '/api/v1/system/cache/remove', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:39:10');
INSERT INTO `sys_oper_log` VALUES (31, '', 0, '/api/v1/system/user/getUserMenus', 'GET', 1, 'demo', '财务部门', '/api/v1/system/user/getUserMenus', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:39:10');
INSERT INTO `sys_oper_log` VALUES (32, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:39:11');
INSERT INTO `sys_oper_log` VALUES (33, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:39:18');
INSERT INTO `sys_oper_log` VALUES (34, '', 0, '/api/v1/system/cache/remove', 'DELETE', 1, 'demo', '财务部门', '/api/v1/system/cache/remove', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:39:22');
INSERT INTO `sys_oper_log` VALUES (35, '', 0, '/api/v1/system/user/getUserMenus', 'GET', 1, 'demo', '财务部门', '/api/v1/system/user/getUserMenus', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:39:22');
INSERT INTO `sys_oper_log` VALUES (36, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:39:22');
INSERT INTO `sys_oper_log` VALUES (37, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:39:30');
INSERT INTO `sys_oper_log` VALUES (38, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:39:38');
INSERT INTO `sys_oper_log` VALUES (39, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:40:45');
INSERT INTO `sys_oper_log` VALUES (40, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:40:49');
INSERT INTO `sys_oper_log` VALUES (41, '', 0, '/api/v1/system/cache/remove', 'DELETE', 1, 'demo', '财务部门', '/api/v1/system/cache/remove', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:42:13');
INSERT INTO `sys_oper_log` VALUES (42, '', 0, '/api/v1/system/user/getUserMenus', 'GET', 1, 'demo', '财务部门', '/api/v1/system/user/getUserMenus', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:42:13');
INSERT INTO `sys_oper_log` VALUES (43, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:42:14');
INSERT INTO `sys_oper_log` VALUES (44, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:43:04');
INSERT INTO `sys_oper_log` VALUES (45, '', 0, '/api/v1/system/user/getUserMenus', 'GET', 1, 'demo', '财务部门', '/api/v1/system/user/getUserMenus', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:43:29');
INSERT INTO `sys_oper_log` VALUES (46, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:43:29');
INSERT INTO `sys_oper_log` VALUES (47, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:45:13');
INSERT INTO `sys_oper_log` VALUES (48, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:45:18');
INSERT INTO `sys_oper_log` VALUES (49, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:45:20');
INSERT INTO `sys_oper_log` VALUES (50, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:45:32');
INSERT INTO `sys_oper_log` VALUES (51, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:47:45');
INSERT INTO `sys_oper_log` VALUES (52, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:47:51');
INSERT INTO `sys_oper_log` VALUES (53, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 22:47:53');
INSERT INTO `sys_oper_log` VALUES (54, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 23:15:16');
INSERT INTO `sys_oper_log` VALUES (55, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 23:16:53');
INSERT INTO `sys_oper_log` VALUES (56, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 23:17:18');
INSERT INTO `sys_oper_log` VALUES (57, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 23:17:44');
INSERT INTO `sys_oper_log` VALUES (58, '', 0, '/api/v1/system/cache/remove', 'DELETE', 1, 'demo', '财务部门', '/api/v1/system/cache/remove', '20.0.0.1', '', '{}', NULL, '2026-05-02 23:20:26');
INSERT INTO `sys_oper_log` VALUES (59, '', 0, '/api/v1/system/user/getUserMenus', 'GET', 1, 'demo', '财务部门', '/api/v1/system/user/getUserMenus', '20.0.0.1', '', '{}', NULL, '2026-05-02 23:20:26');
INSERT INTO `sys_oper_log` VALUES (60, '', 0, '/api/v1/system/personal/getPersonalInfo', 'GET', 1, 'demo', '财务部门', '/api/v1/system/personal/getPersonalInfo', '20.0.0.1', '', '{}', NULL, '2026-05-02 23:20:27');
INSERT INTO `sys_oper_log` VALUES (61, '', 0, '/api/v1/system/user/getUserMenus', 'GET', 1, 'demo', '财务部门', '/api/v1/system/user/getUserMenus', '20.0.0.1', '', '{}', NULL, '2026-05-02 23:24:58');
INSERT INTO `sys_oper_log` VALUES (62, '', 0, '/api/v1/system/dict/data/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/list?pageNum=1&pageSize=20&dictLabel=&status=', '20.0.0.1', '', '{\"dictLabel\":\"\",\"pageNum\":\"1\",\"pageSize\":\"20\",\"status\":\"\"}', NULL, '2026-05-03 00:10:57');
INSERT INTO `sys_oper_log` VALUES (63, '', 0, '/api/v1/system/dict/type/optionSelect', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/type/optionSelect?all=true', '20.0.0.1', '', '{\"all\":\"true\"}', NULL, '2026-05-03 00:10:57');
INSERT INTO `sys_oper_log` VALUES (64, '', 0, '/api/v1/system/uEditor/action', 'GET', 1, 'demo', '财务部门', '/api/v1/system/uEditor/action?token=7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD%2BHSuTVFdqV%2Fd8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i%2FnnSFpaakp0UZTkbau0NYLf0taY%2FCA%3D%3D&action=config&callback=bd__editor__rgp6g3', '20.0.0.1', '', '{\"action\":\"config\",\"callback\":\"bd__editor__rgp6g3\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 21:48:16');
INSERT INTO `sys_oper_log` VALUES (65, '', 0, '/api/v1/system/uEditor/action', 'GET', 1, 'demo', '财务部门', '/api/v1/system/uEditor/action?token=7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD%2BHSuTVFdqV%2Fd8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i%2FnnSFpaakp0UZTkbau0NYLf0taY%2FCA%3D%3D&action=config&callback=bd__editor__88zgiy', '20.0.0.1', '', '{\"action\":\"config\",\"callback\":\"bd__editor__88zgiy\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 21:49:58');
INSERT INTO `sys_oper_log` VALUES (66, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=notice_tag&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"notice_tag\"}', NULL, '2026-05-04 21:57:32');
INSERT INTO `sys_oper_log` VALUES (67, '通知公告管理', 0, '/api/v1/system/sysNotice/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysNotice/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 21:57:32');
INSERT INTO `sys_oper_log` VALUES (68, '', 0, '/api/v1/system/sysNotice/listShow', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysNotice/listShow?pageNum=1&pageSize=10&type=1', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\",\"type\":\"1\"}', NULL, '2026-05-04 21:57:35');
INSERT INTO `sys_oper_log` VALUES (69, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 21:57:56');
INSERT INTO `sys_oper_log` VALUES (70, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 21:57:56');
INSERT INTO `sys_oper_log` VALUES (71, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 21:57:56');
INSERT INTO `sys_oper_log` VALUES (72, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 21:58:57');
INSERT INTO `sys_oper_log` VALUES (73, '', 0, '/api/v1/system/config/getBatchBykey', 'GET', 1, 'demo', '财务部门', '/api/v1/system/config/getBatchBykey?keys%5B%5D=sys.uploadFile.imageType&keys%5B%5D=sys.uploadFile.imageSize', '20.0.0.1', '', '{\"keys\":[\"sys.uploadFile.imageType\",\"sys.uploadFile.imageSize\"]}', NULL, '2026-05-04 21:58:57');
INSERT INTO `sys_oper_log` VALUES (74, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 21:59:17');
INSERT INTO `sys_oper_log` VALUES (75, '', 0, '/api/v1/system/upload/singleImg', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/singleImg', '20.0.0.1', '', '{\"file\":{\"Filename\":\"co9copop81co0gysbz.jpg\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"co9copop81co0gysbz.jpg\\\"\"],\"Content-Type\":[\"image/jpeg\"]},\"Size\":34277},\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 21:59:17');
INSERT INTO `sys_oper_log` VALUES (76, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 21:59:17');
INSERT INTO `sys_oper_log` VALUES (77, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 21:59:43');
INSERT INTO `sys_oper_log` VALUES (78, '', 0, '/api/v1/system/config/getBatchBykey', 'GET', 1, 'demo', '财务部门', '/api/v1/system/config/getBatchBykey?keys%5B%5D=sys.uploadFile.imageType&keys%5B%5D=sys.uploadFile.imageSize', '20.0.0.1', '', '{\"keys\":[\"sys.uploadFile.imageType\",\"sys.uploadFile.imageSize\"]}', NULL, '2026-05-04 21:59:43');
INSERT INTO `sys_oper_log` VALUES (79, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 21:59:51');
INSERT INTO `sys_oper_log` VALUES (80, '', 0, '/api/v1/system/upload/singleImg', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/singleImg', '20.0.0.1', '', '{\"file\":{\"Filename\":\"co9copop81co0gysbz.jpg\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"co9copop81co0gysbz.jpg\\\"\"],\"Content-Type\":[\"image/jpeg\"]},\"Size\":34277},\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 21:59:51');
INSERT INTO `sys_oper_log` VALUES (81, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 21:59:51');
INSERT INTO `sys_oper_log` VALUES (82, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:00:21');
INSERT INTO `sys_oper_log` VALUES (83, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:11:43');
INSERT INTO `sys_oper_log` VALUES (84, '', 0, '/api/v1/system/config/getBatchBykey', 'GET', 1, 'demo', '财务部门', '/api/v1/system/config/getBatchBykey?keys%5B%5D=sys.uploadFile.imageType&keys%5B%5D=sys.uploadFile.imageSize', '20.0.0.1', '', '{\"keys\":[\"sys.uploadFile.imageType\",\"sys.uploadFile.imageSize\"]}', NULL, '2026-05-04 22:11:43');
INSERT INTO `sys_oper_log` VALUES (85, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:11:53');
INSERT INTO `sys_oper_log` VALUES (86, '', 0, '/api/v1/system/upload/singleImg', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/singleImg', '20.0.0.1', '', '{\"file\":{\"Filename\":\"fe4b0029b62a1c4bab23ff099a61b31d.jpeg\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"fe4b0029b62a1c4bab23ff099a61b31d.jpeg\\\"\"],\"Content-Type\":[\"image/jpeg\"]},\"Size\":118166},\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 22:11:53');
INSERT INTO `sys_oper_log` VALUES (87, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:11:53');
INSERT INTO `sys_oper_log` VALUES (88, '', 0, '/api/v1/system/config/getBatchBykey', 'GET', 1, 'demo', '财务部门', '/api/v1/system/config/getBatchBykey?keys%5B%5D=sys.uploadFile.fileType&keys%5B%5D=sys.uploadFile.fileSize', '20.0.0.1', '', '{\"keys\":[\"sys.uploadFile.fileType\",\"sys.uploadFile.fileSize\"]}', NULL, '2026-05-04 22:12:14');
INSERT INTO `sys_oper_log` VALUES (89, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:12:14');
INSERT INTO `sys_oper_log` VALUES (90, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:12:34');
INSERT INTO `sys_oper_log` VALUES (91, '', 0, '/api/v1/system/config/getBatchBykey', 'GET', 1, 'demo', '财务部门', '/api/v1/system/config/getBatchBykey?keys%5B%5D=sys.uploadFile.imageType&keys%5B%5D=sys.uploadFile.imageSize', '20.0.0.1', '', '{\"keys\":[\"sys.uploadFile.imageType\",\"sys.uploadFile.imageSize\"]}', NULL, '2026-05-04 22:12:34');
INSERT INTO `sys_oper_log` VALUES (92, '', 0, '/api/v1/system/upload/singleImg', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/singleImg', '20.0.0.1', '', '{\"file\":{\"Filename\":\"61fb465f0b43ee1890dd9c26c3a9cc33.jpg\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"61fb465f0b43ee1890dd9c26c3a9cc33.jpg\\\"\"],\"Content-Type\":[\"image/jpeg\"]},\"Size\":34277},\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 22:12:48');
INSERT INTO `sys_oper_log` VALUES (93, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:12:48');
INSERT INTO `sys_oper_log` VALUES (94, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:12:49');
INSERT INTO `sys_oper_log` VALUES (95, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:13:10');
INSERT INTO `sys_oper_log` VALUES (96, '', 0, '/api/v1/system/config/getBatchBykey', 'GET', 1, 'demo', '财务部门', '/api/v1/system/config/getBatchBykey?keys%5B%5D=sys.uploadFile.imageType&keys%5B%5D=sys.uploadFile.imageSize', '20.0.0.1', '', '{\"keys\":[\"sys.uploadFile.imageType\",\"sys.uploadFile.imageSize\"]}', NULL, '2026-05-04 22:13:10');
INSERT INTO `sys_oper_log` VALUES (97, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:13:22');
INSERT INTO `sys_oper_log` VALUES (98, '', 0, '/api/v1/system/upload/singleImg', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/singleImg', '20.0.0.1', '', '{\"file\":{\"Filename\":\"61fb465f0b43ee1890dd9c26c3a9cc33.jpg\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"61fb465f0b43ee1890dd9c26c3a9cc33.jpg\\\"\"],\"Content-Type\":[\"image/jpeg\"]},\"Size\":34277},\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 22:13:22');
INSERT INTO `sys_oper_log` VALUES (99, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:13:22');
INSERT INTO `sys_oper_log` VALUES (100, '', 0, '/api/v1/system/config/getBatchBykey', 'GET', 1, 'demo', '财务部门', '/api/v1/system/config/getBatchBykey?keys%5B%5D=sys.uploadFile.imageType&keys%5B%5D=sys.uploadFile.imageSize', '20.0.0.1', '', '{\"keys\":[\"sys.uploadFile.imageType\",\"sys.uploadFile.imageSize\"]}', NULL, '2026-05-04 22:13:33');
INSERT INTO `sys_oper_log` VALUES (101, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:13:33');
INSERT INTO `sys_oper_log` VALUES (102, '', 0, '/api/v1/system/upload/singleImg', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/singleImg', '20.0.0.1', '', '{\"file\":{\"Filename\":\"61fb465f0b43ee1890dd9c26c3a9cc33.jpg\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"61fb465f0b43ee1890dd9c26c3a9cc33.jpg\\\"\"],\"Content-Type\":[\"image/jpeg\"]},\"Size\":34277},\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 22:13:42');
INSERT INTO `sys_oper_log` VALUES (103, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:13:42');
INSERT INTO `sys_oper_log` VALUES (104, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:13:42');
INSERT INTO `sys_oper_log` VALUES (105, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:15:28');
INSERT INTO `sys_oper_log` VALUES (106, '', 0, '/api/v1/system/config/getBatchBykey', 'GET', 1, 'demo', '财务部门', '/api/v1/system/config/getBatchBykey?keys%5B%5D=sys.uploadFile.imageType&keys%5B%5D=sys.uploadFile.imageSize', '20.0.0.1', '', '{\"keys\":[\"sys.uploadFile.imageType\",\"sys.uploadFile.imageSize\"]}', NULL, '2026-05-04 22:15:28');
INSERT INTO `sys_oper_log` VALUES (107, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:16:28');
INSERT INTO `sys_oper_log` VALUES (108, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:16:28');
INSERT INTO `sys_oper_log` VALUES (109, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:16:28');
INSERT INTO `sys_oper_log` VALUES (110, '', 0, '/api/v1/system/config/getBatchBykey', 'GET', 1, 'demo', '财务部门', '/api/v1/system/config/getBatchBykey?keys%5B%5D=sys.uploadFile.fileType&keys%5B%5D=sys.uploadFile.fileSize', '20.0.0.1', '', '{\"keys\":[\"sys.uploadFile.fileType\",\"sys.uploadFile.fileSize\"]}', NULL, '2026-05-04 22:16:34');
INSERT INTO `sys_oper_log` VALUES (111, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:16:34');
INSERT INTO `sys_oper_log` VALUES (112, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:16:51');
INSERT INTO `sys_oper_log` VALUES (113, '', 0, '/api/v1/system/upload/singleFile', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/singleFile', '20.0.0.1', '', '{\"file\":{\"Filename\":\"video.mp4\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"video.mp4\\\"\"],\"Content-Type\":[\"video/mp4\"]},\"Size\":7033146},\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 22:16:51');
INSERT INTO `sys_oper_log` VALUES (114, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:16:51');
INSERT INTO `sys_oper_log` VALUES (115, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:17:18');
INSERT INTO `sys_oper_log` VALUES (116, '', 0, '/api/v1/system/config/getBatchBykey', 'GET', 1, 'demo', '财务部门', '/api/v1/system/config/getBatchBykey?keys%5B%5D=sys.uploadFile.imageType&keys%5B%5D=sys.uploadFile.imageSize', '20.0.0.1', '', '{\"keys\":[\"sys.uploadFile.imageType\",\"sys.uploadFile.imageSize\"]}', NULL, '2026-05-04 22:17:18');
INSERT INTO `sys_oper_log` VALUES (117, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:17:30');
INSERT INTO `sys_oper_log` VALUES (118, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:17:30');
INSERT INTO `sys_oper_log` VALUES (119, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:17:30');
INSERT INTO `sys_oper_log` VALUES (120, '', 0, '/api/v1/system/config/getBatchBykey', 'GET', 1, 'demo', '财务部门', '/api/v1/system/config/getBatchBykey?keys%5B%5D=sys.uploadFile.fileType&keys%5B%5D=sys.uploadFile.fileSize', '20.0.0.1', '', '{\"keys\":[\"sys.uploadFile.fileType\",\"sys.uploadFile.fileSize\"]}', NULL, '2026-05-04 22:17:34');
INSERT INTO `sys_oper_log` VALUES (121, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:17:34');
INSERT INTO `sys_oper_log` VALUES (122, '', 0, '/api/v1/system/config/getBatchBykey', 'GET', 1, 'demo', '财务部门', '/api/v1/system/config/getBatchBykey?keys%5B%5D=sys.uploadFile.fileType&keys%5B%5D=sys.uploadFile.fileSize', '20.0.0.1', '', '{\"keys\":[\"sys.uploadFile.fileType\",\"sys.uploadFile.fileSize\"]}', NULL, '2026-05-04 22:17:52');
INSERT INTO `sys_oper_log` VALUES (123, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:17:52');
INSERT INTO `sys_oper_log` VALUES (124, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:18:15');
INSERT INTO `sys_oper_log` VALUES (125, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:18:23');
INSERT INTO `sys_oper_log` VALUES (126, '', 0, '/api/v1/system/upload/checkMultipart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/checkMultipart', '20.0.0.1', '', '{\"fileName\":\"video.mp4\",\"md5\":\"0033ba3c5b3f7e8e924575aa53fd15f8\",\"shardsCount\":4,\"size\":7033146}', NULL, '2026-05-04 22:18:23');
INSERT INTO `sys_oper_log` VALUES (127, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10&drive=0', '20.0.0.1', '', '{\"drive\":\"0\",\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:18:23');
INSERT INTO `sys_oper_log` VALUES (128, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:40:47');
INSERT INTO `sys_oper_log` VALUES (129, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 22:40:47');
INSERT INTO `sys_oper_log` VALUES (130, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 22:40:47');
INSERT INTO `sys_oper_log` VALUES (131, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 22:44:42');
INSERT INTO `sys_oper_log` VALUES (132, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:44:42');
INSERT INTO `sys_oper_log` VALUES (133, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 22:44:42');
INSERT INTO `sys_oper_log` VALUES (134, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 22:45:25');
INSERT INTO `sys_oper_log` VALUES (135, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:45:25');
INSERT INTO `sys_oper_log` VALUES (136, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 22:45:25');
INSERT INTO `sys_oper_log` VALUES (137, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:45:48');
INSERT INTO `sys_oper_log` VALUES (138, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 22:45:48');
INSERT INTO `sys_oper_log` VALUES (139, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 22:45:48');
INSERT INTO `sys_oper_log` VALUES (140, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 22:49:46');
INSERT INTO `sys_oper_log` VALUES (141, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 22:49:46');
INSERT INTO `sys_oper_log` VALUES (142, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:49:46');
INSERT INTO `sys_oper_log` VALUES (143, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 22:51:28');
INSERT INTO `sys_oper_log` VALUES (144, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 22:51:28');
INSERT INTO `sys_oper_log` VALUES (145, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 22:51:28');
INSERT INTO `sys_oper_log` VALUES (146, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 23:00:17');
INSERT INTO `sys_oper_log` VALUES (147, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 23:00:17');
INSERT INTO `sys_oper_log` VALUES (148, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:00:17');
INSERT INTO `sys_oper_log` VALUES (149, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 23:00:43');
INSERT INTO `sys_oper_log` VALUES (150, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:00:43');
INSERT INTO `sys_oper_log` VALUES (151, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 23:00:43');
INSERT INTO `sys_oper_log` VALUES (152, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:02:57');
INSERT INTO `sys_oper_log` VALUES (153, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 23:02:57');
INSERT INTO `sys_oper_log` VALUES (154, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 23:02:57');
INSERT INTO `sys_oper_log` VALUES (155, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 23:06:17');
INSERT INTO `sys_oper_log` VALUES (156, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 23:06:17');
INSERT INTO `sys_oper_log` VALUES (157, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:06:17');
INSERT INTO `sys_oper_log` VALUES (158, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 23:16:13');
INSERT INTO `sys_oper_log` VALUES (159, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:16:13');
INSERT INTO `sys_oper_log` VALUES (160, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 23:16:13');
INSERT INTO `sys_oper_log` VALUES (161, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 23:33:43');
INSERT INTO `sys_oper_log` VALUES (162, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:33:43');
INSERT INTO `sys_oper_log` VALUES (163, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 23:33:43');
INSERT INTO `sys_oper_log` VALUES (164, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:40:06');
INSERT INTO `sys_oper_log` VALUES (165, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 23:40:06');
INSERT INTO `sys_oper_log` VALUES (166, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 23:40:06');
INSERT INTO `sys_oper_log` VALUES (167, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:42:07');
INSERT INTO `sys_oper_log` VALUES (168, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 23:42:07');
INSERT INTO `sys_oper_log` VALUES (169, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 23:42:07');
INSERT INTO `sys_oper_log` VALUES (170, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 23:43:01');
INSERT INTO `sys_oper_log` VALUES (171, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:43:01');
INSERT INTO `sys_oper_log` VALUES (172, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 23:43:01');
INSERT INTO `sys_oper_log` VALUES (173, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:43:48');
INSERT INTO `sys_oper_log` VALUES (174, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 23:43:48');
INSERT INTO `sys_oper_log` VALUES (175, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 23:43:48');
INSERT INTO `sys_oper_log` VALUES (176, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:44:35');
INSERT INTO `sys_oper_log` VALUES (177, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 23:44:35');
INSERT INTO `sys_oper_log` VALUES (178, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 23:44:35');
INSERT INTO `sys_oper_log` VALUES (179, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:44:59');
INSERT INTO `sys_oper_log` VALUES (180, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 23:44:59');
INSERT INTO `sys_oper_log` VALUES (181, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 23:44:59');
INSERT INTO `sys_oper_log` VALUES (182, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:45:16');
INSERT INTO `sys_oper_log` VALUES (183, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 23:45:16');
INSERT INTO `sys_oper_log` VALUES (184, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 23:45:16');
INSERT INTO `sys_oper_log` VALUES (185, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:48:06');
INSERT INTO `sys_oper_log` VALUES (186, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 23:48:06');
INSERT INTO `sys_oper_log` VALUES (187, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 23:48:06');
INSERT INTO `sys_oper_log` VALUES (188, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:49:58');
INSERT INTO `sys_oper_log` VALUES (189, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 23:49:58');
INSERT INTO `sys_oper_log` VALUES (190, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 23:49:58');
INSERT INTO `sys_oper_log` VALUES (191, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 23:52:15');
INSERT INTO `sys_oper_log` VALUES (192, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:52:15');
INSERT INTO `sys_oper_log` VALUES (193, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 23:52:15');
INSERT INTO `sys_oper_log` VALUES (194, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:52:59');
INSERT INTO `sys_oper_log` VALUES (195, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 23:52:59');
INSERT INTO `sys_oper_log` VALUES (196, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 23:52:59');
INSERT INTO `sys_oper_log` VALUES (197, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 23:53:30');
INSERT INTO `sys_oper_log` VALUES (198, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:53:30');
INSERT INTO `sys_oper_log` VALUES (199, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 23:53:30');
INSERT INTO `sys_oper_log` VALUES (200, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 23:53:58');
INSERT INTO `sys_oper_log` VALUES (201, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 23:53:58');
INSERT INTO `sys_oper_log` VALUES (202, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:53:58');
INSERT INTO `sys_oper_log` VALUES (203, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:54:12');
INSERT INTO `sys_oper_log` VALUES (204, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 23:54:12');
INSERT INTO `sys_oper_log` VALUES (205, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 23:54:12');
INSERT INTO `sys_oper_log` VALUES (206, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 23:55:23');
INSERT INTO `sys_oper_log` VALUES (207, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:55:23');
INSERT INTO `sys_oper_log` VALUES (208, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 23:55:23');
INSERT INTO `sys_oper_log` VALUES (209, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:57:32');
INSERT INTO `sys_oper_log` VALUES (210, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_drive&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_drive\"}', NULL, '2026-05-04 23:57:32');
INSERT INTO `sys_oper_log` VALUES (211, '', 0, '/api/v1/system/dict/data/getDictData', 'GET', 1, 'demo', '财务部门', '/api/v1/system/dict/data/getDictData?dictType=sys_upload_file_type&defaultValue=', '20.0.0.1', '', '{\"defaultValue\":\"\",\"dictType\":\"sys_upload_file_type\"}', NULL, '2026-05-04 23:57:32');
INSERT INTO `sys_oper_log` VALUES (212, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:58:23');
INSERT INTO `sys_oper_log` VALUES (213, '', 0, '/api/v1/system/config/getBatchBykey', 'GET', 1, 'demo', '财务部门', '/api/v1/system/config/getBatchBykey?keys%5B%5D=sys.uploadFile.fileType&keys%5B%5D=sys.uploadFile.fileSize', '20.0.0.1', '', '{\"keys\":[\"sys.uploadFile.fileType\",\"sys.uploadFile.fileSize\"]}', NULL, '2026-05-04 23:58:23');
INSERT INTO `sys_oper_log` VALUES (214, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:58:41');
INSERT INTO `sys_oper_log` VALUES (215, '', 0, '/api/v1/system/config/getBatchBykey', 'GET', 1, 'demo', '财务部门', '/api/v1/system/config/getBatchBykey?keys%5B%5D=sys.uploadFile.imageType&keys%5B%5D=sys.uploadFile.imageSize', '20.0.0.1', '', '{\"keys\":[\"sys.uploadFile.imageType\",\"sys.uploadFile.imageSize\"]}', NULL, '2026-05-04 23:58:41');
INSERT INTO `sys_oper_log` VALUES (216, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:58:45');
INSERT INTO `sys_oper_log` VALUES (217, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:59:01');
INSERT INTO `sys_oper_log` VALUES (218, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:59:07');
INSERT INTO `sys_oper_log` VALUES (219, '', 0, '/api/v1/system/upload/checkMultipart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/checkMultipart', '20.0.0.1', '', '{\"fileName\":\"video1.mp4\",\"md5\":\"e9fcf0d52f6a33507b5053cb281b2f09\",\"shardsCount\":18,\"size\":36766026}', NULL, '2026-05-04 23:59:08');
INSERT INTO `sys_oper_log` VALUES (220, '', 0, '/api/v1/system/upload/uploadPart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/uploadPart', '20.0.0.1', '', '{\"file\":{\"Filename\":\"1.part\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"blob\\\"\"],\"Content-Type\":[\"application/octet-stream\"]},\"Size\":2097152},\"fileName\":\"video1.mp4\",\"index\":\"1\",\"md5\":\"e9fcf0d52f6a33507b5053cb281b2f09\",\"shardsCount\":\"18\",\"size\":\"36766026\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 23:59:08');
INSERT INTO `sys_oper_log` VALUES (221, '', 0, '/api/v1/system/upload/uploadPart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/uploadPart', '20.0.0.1', '', '{\"file\":{\"Filename\":\"2.part\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"blob\\\"\"],\"Content-Type\":[\"application/octet-stream\"]},\"Size\":2097152},\"fileName\":\"video1.mp4\",\"index\":\"2\",\"md5\":\"e9fcf0d52f6a33507b5053cb281b2f09\",\"shardsCount\":\"18\",\"size\":\"36766026\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 23:59:08');
INSERT INTO `sys_oper_log` VALUES (222, '', 0, '/api/v1/system/upload/uploadPart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/uploadPart', '20.0.0.1', '', '{\"file\":{\"Filename\":\"3.part\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"blob\\\"\"],\"Content-Type\":[\"application/octet-stream\"]},\"Size\":2097152},\"fileName\":\"video1.mp4\",\"index\":\"3\",\"md5\":\"e9fcf0d52f6a33507b5053cb281b2f09\",\"shardsCount\":\"18\",\"size\":\"36766026\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 23:59:08');
INSERT INTO `sys_oper_log` VALUES (223, '', 0, '/api/v1/system/upload/uploadPart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/uploadPart', '20.0.0.1', '', '{\"file\":{\"Filename\":\"4.part\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"blob\\\"\"],\"Content-Type\":[\"application/octet-stream\"]},\"Size\":2097152},\"fileName\":\"video1.mp4\",\"index\":\"4\",\"md5\":\"e9fcf0d52f6a33507b5053cb281b2f09\",\"shardsCount\":\"18\",\"size\":\"36766026\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 23:59:08');
INSERT INTO `sys_oper_log` VALUES (224, '', 0, '/api/v1/system/upload/uploadPart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/uploadPart', '20.0.0.1', '', '{\"file\":{\"Filename\":\"5.part\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"blob\\\"\"],\"Content-Type\":[\"application/octet-stream\"]},\"Size\":2097152},\"fileName\":\"video1.mp4\",\"index\":\"5\",\"md5\":\"e9fcf0d52f6a33507b5053cb281b2f09\",\"shardsCount\":\"18\",\"size\":\"36766026\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 23:59:08');
INSERT INTO `sys_oper_log` VALUES (225, '', 0, '/api/v1/system/upload/uploadPart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/uploadPart', '20.0.0.1', '', '{\"file\":{\"Filename\":\"6.part\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"blob\\\"\"],\"Content-Type\":[\"application/octet-stream\"]},\"Size\":2097152},\"fileName\":\"video1.mp4\",\"index\":\"6\",\"md5\":\"e9fcf0d52f6a33507b5053cb281b2f09\",\"shardsCount\":\"18\",\"size\":\"36766026\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 23:59:08');
INSERT INTO `sys_oper_log` VALUES (226, '', 0, '/api/v1/system/upload/uploadPart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/uploadPart', '20.0.0.1', '', '{\"file\":{\"Filename\":\"7.part\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"blob\\\"\"],\"Content-Type\":[\"application/octet-stream\"]},\"Size\":2097152},\"fileName\":\"video1.mp4\",\"index\":\"7\",\"md5\":\"e9fcf0d52f6a33507b5053cb281b2f09\",\"shardsCount\":\"18\",\"size\":\"36766026\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 23:59:08');
INSERT INTO `sys_oper_log` VALUES (227, '', 0, '/api/v1/system/upload/uploadPart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/uploadPart', '20.0.0.1', '', '{\"file\":{\"Filename\":\"8.part\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"blob\\\"\"],\"Content-Type\":[\"application/octet-stream\"]},\"Size\":2097152},\"fileName\":\"video1.mp4\",\"index\":\"8\",\"md5\":\"e9fcf0d52f6a33507b5053cb281b2f09\",\"shardsCount\":\"18\",\"size\":\"36766026\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 23:59:08');
INSERT INTO `sys_oper_log` VALUES (228, '', 0, '/api/v1/system/upload/uploadPart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/uploadPart', '20.0.0.1', '', '{\"file\":{\"Filename\":\"9.part\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"blob\\\"\"],\"Content-Type\":[\"application/octet-stream\"]},\"Size\":2097152},\"fileName\":\"video1.mp4\",\"index\":\"9\",\"md5\":\"e9fcf0d52f6a33507b5053cb281b2f09\",\"shardsCount\":\"18\",\"size\":\"36766026\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 23:59:08');
INSERT INTO `sys_oper_log` VALUES (229, '', 0, '/api/v1/system/upload/uploadPart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/uploadPart', '20.0.0.1', '', '{\"file\":{\"Filename\":\"10.part\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"blob\\\"\"],\"Content-Type\":[\"application/octet-stream\"]},\"Size\":2097152},\"fileName\":\"video1.mp4\",\"index\":\"10\",\"md5\":\"e9fcf0d52f6a33507b5053cb281b2f09\",\"shardsCount\":\"18\",\"size\":\"36766026\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 23:59:08');
INSERT INTO `sys_oper_log` VALUES (230, '', 0, '/api/v1/system/upload/uploadPart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/uploadPart', '20.0.0.1', '', '{\"file\":{\"Filename\":\"11.part\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"blob\\\"\"],\"Content-Type\":[\"application/octet-stream\"]},\"Size\":2097152},\"fileName\":\"video1.mp4\",\"index\":\"11\",\"md5\":\"e9fcf0d52f6a33507b5053cb281b2f09\",\"shardsCount\":\"18\",\"size\":\"36766026\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 23:59:08');
INSERT INTO `sys_oper_log` VALUES (231, '', 0, '/api/v1/system/upload/uploadPart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/uploadPart', '20.0.0.1', '', '{\"file\":{\"Filename\":\"12.part\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"blob\\\"\"],\"Content-Type\":[\"application/octet-stream\"]},\"Size\":2097152},\"fileName\":\"video1.mp4\",\"index\":\"12\",\"md5\":\"e9fcf0d52f6a33507b5053cb281b2f09\",\"shardsCount\":\"18\",\"size\":\"36766026\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 23:59:08');
INSERT INTO `sys_oper_log` VALUES (232, '', 0, '/api/v1/system/upload/uploadPart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/uploadPart', '20.0.0.1', '', '{\"file\":{\"Filename\":\"13.part\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"blob\\\"\"],\"Content-Type\":[\"application/octet-stream\"]},\"Size\":2097152},\"fileName\":\"video1.mp4\",\"index\":\"13\",\"md5\":\"e9fcf0d52f6a33507b5053cb281b2f09\",\"shardsCount\":\"18\",\"size\":\"36766026\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 23:59:08');
INSERT INTO `sys_oper_log` VALUES (233, '', 0, '/api/v1/system/upload/uploadPart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/uploadPart', '20.0.0.1', '', '{\"file\":{\"Filename\":\"14.part\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"blob\\\"\"],\"Content-Type\":[\"application/octet-stream\"]},\"Size\":2097152},\"fileName\":\"video1.mp4\",\"index\":\"14\",\"md5\":\"e9fcf0d52f6a33507b5053cb281b2f09\",\"shardsCount\":\"18\",\"size\":\"36766026\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 23:59:08');
INSERT INTO `sys_oper_log` VALUES (234, '', 0, '/api/v1/system/upload/uploadPart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/uploadPart', '20.0.0.1', '', '{\"file\":{\"Filename\":\"15.part\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"blob\\\"\"],\"Content-Type\":[\"application/octet-stream\"]},\"Size\":2097152},\"fileName\":\"video1.mp4\",\"index\":\"15\",\"md5\":\"e9fcf0d52f6a33507b5053cb281b2f09\",\"shardsCount\":\"18\",\"size\":\"36766026\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 23:59:08');
INSERT INTO `sys_oper_log` VALUES (235, '', 0, '/api/v1/system/upload/uploadPart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/uploadPart', '20.0.0.1', '', '{\"file\":{\"Filename\":\"16.part\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"blob\\\"\"],\"Content-Type\":[\"application/octet-stream\"]},\"Size\":2097152},\"fileName\":\"video1.mp4\",\"index\":\"16\",\"md5\":\"e9fcf0d52f6a33507b5053cb281b2f09\",\"shardsCount\":\"18\",\"size\":\"36766026\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 23:59:08');
INSERT INTO `sys_oper_log` VALUES (236, '', 0, '/api/v1/system/upload/uploadPart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/uploadPart', '20.0.0.1', '', '{\"file\":{\"Filename\":\"17.part\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"blob\\\"\"],\"Content-Type\":[\"application/octet-stream\"]},\"Size\":2097152},\"fileName\":\"video1.mp4\",\"index\":\"17\",\"md5\":\"e9fcf0d52f6a33507b5053cb281b2f09\",\"shardsCount\":\"18\",\"size\":\"36766026\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 23:59:08');
INSERT INTO `sys_oper_log` VALUES (237, '', 0, '/api/v1/system/upload/uploadPart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/uploadPart', '20.0.0.1', '', '{\"file\":{\"Filename\":\"18.part\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"blob\\\"\"],\"Content-Type\":[\"application/octet-stream\"]},\"Size\":1114442},\"fileName\":\"video1.mp4\",\"index\":\"18\",\"md5\":\"e9fcf0d52f6a33507b5053cb281b2f09\",\"shardsCount\":\"18\",\"size\":\"36766026\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 23:59:08');
INSERT INTO `sys_oper_log` VALUES (238, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:59:08');
INSERT INTO `sys_oper_log` VALUES (239, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:59:21');
INSERT INTO `sys_oper_log` VALUES (240, '', 0, '/api/v1/system/config/getBatchBykey', 'GET', 1, 'demo', '财务部门', '/api/v1/system/config/getBatchBykey?keys%5B%5D=sys.uploadFile.imageType&keys%5B%5D=sys.uploadFile.imageSize', '20.0.0.1', '', '{\"keys\":[\"sys.uploadFile.imageType\",\"sys.uploadFile.imageSize\"]}', NULL, '2026-05-04 23:59:21');
INSERT INTO `sys_oper_log` VALUES (241, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:59:27');
INSERT INTO `sys_oper_log` VALUES (242, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:59:27');
INSERT INTO `sys_oper_log` VALUES (243, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:59:27');
INSERT INTO `sys_oper_log` VALUES (244, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:59:32');
INSERT INTO `sys_oper_log` VALUES (245, '', 0, '/api/v1/system/config/getBatchBykey', 'GET', 1, 'demo', '财务部门', '/api/v1/system/config/getBatchBykey?keys%5B%5D=sys.uploadFile.fileType&keys%5B%5D=sys.uploadFile.fileSize', '20.0.0.1', '', '{\"keys\":[\"sys.uploadFile.fileType\",\"sys.uploadFile.fileSize\"]}', NULL, '2026-05-04 23:59:32');
INSERT INTO `sys_oper_log` VALUES (246, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:59:46');
INSERT INTO `sys_oper_log` VALUES (247, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:59:53');
INSERT INTO `sys_oper_log` VALUES (248, '', 0, '/api/v1/system/upload/checkMultipart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/checkMultipart', '20.0.0.1', '', '{\"fileName\":\"video2.mp4\",\"md5\":\"81d9a633f27c0147a48f71b25b0102f1\",\"shardsCount\":3,\"size\":5288602}', NULL, '2026-05-04 23:59:53');
INSERT INTO `sys_oper_log` VALUES (249, '', 0, '/api/v1/system/upload/uploadPart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/uploadPart', '20.0.0.1', '', '{\"file\":{\"Filename\":\"1.part\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"blob\\\"\"],\"Content-Type\":[\"application/octet-stream\"]},\"Size\":2097152},\"fileName\":\"video2.mp4\",\"index\":\"1\",\"md5\":\"81d9a633f27c0147a48f71b25b0102f1\",\"shardsCount\":\"3\",\"size\":\"5288602\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 23:59:53');
INSERT INTO `sys_oper_log` VALUES (250, '', 0, '/api/v1/system/upload/uploadPart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/uploadPart', '20.0.0.1', '', '{\"file\":{\"Filename\":\"2.part\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"blob\\\"\"],\"Content-Type\":[\"application/octet-stream\"]},\"Size\":2097152},\"fileName\":\"video2.mp4\",\"index\":\"2\",\"md5\":\"81d9a633f27c0147a48f71b25b0102f1\",\"shardsCount\":\"3\",\"size\":\"5288602\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 23:59:53');
INSERT INTO `sys_oper_log` VALUES (251, '', 0, '/api/v1/system/upload/uploadPart', 'POST', 1, 'demo', '财务部门', '/api/v1/system/upload/uploadPart', '20.0.0.1', '', '{\"file\":{\"Filename\":\"3.part\",\"Header\":{\"Content-Disposition\":[\"form-data; name=\\\"file\\\"; filename=\\\"blob\\\"\"],\"Content-Type\":[\"application/octet-stream\"]},\"Size\":1094298},\"fileName\":\"video2.mp4\",\"index\":\"3\",\"md5\":\"81d9a633f27c0147a48f71b25b0102f1\",\"shardsCount\":\"3\",\"size\":\"5288602\",\"token\":\"7ZUSfVIf2HyYjcv86SKPPs29v003ECPEScsdYsYYqO34NPWToda7vzRxbAEp7oUuriUf9bmAKD+HSuTVFdqV/d8ZnNCKNhUZTuS3uNw6qK11TmzRNwf5T18i/nnSFpaakp0UZTkbau0NYLf0taY/CA==\"}', NULL, '2026-05-04 23:59:53');
INSERT INTO `sys_oper_log` VALUES (252, '附件管理', 0, '/api/v1/system/sysAttachment/list', 'GET', 1, 'demo', '财务部门', '/api/v1/system/sysAttachment/list?pageNum=1&pageSize=10', '20.0.0.1', '', '{\"pageNum\":\"1\",\"pageSize\":\"10\"}', NULL, '2026-05-04 23:59:53');
...
INSERT INTO `sys_role` VALUES (2, 1, 1, 0, '普通管理员', '备注', 5, '2022-04-01 11:38:39', '2025-08-14 14:52:32', 0, '{\"effectiveType\":0,\"weekDay\":[1,2,3,4,5],\"dayRange\":[\"2024-04-12 08:00:00\",\"2024-04-12 18:00:00\"],\"dateRange\":null}');
...
INSERT INTO `sys_user` VALUES (3, 'zs', '16399669855', '张三', 0, '41e3778c20338f4d7d6cc886fd3b2a52', 'redoHIj524', 1, 'zs@qq.com', 0, 'https://yxh-1301841944.cos.ap-chongqing.myqcloud.com/gfast/2021-08-02/cd8nif79egjg9kbkgk.jpeg', 101, '', 1, '', '', '::1', '2025-10-27 15:59:57', '2021-06-22 17:58:00', '2024-09-14 09:08:10', NULL, '');
...
CREATE TABLE `tools_gen_table`  (
  ...
  `group` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '数据库group',
  ...
  `sort_column` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '排序字段名',
  ...
  `attachments` json NULL COMMENT '副表信息',
  PRIMARY KEY (`table_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 113 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '代码生成业务表' ROW_FORMAT = COMPACT;

-- ----------------------------
-- Records of tools_gen_table
-- ----------------------------
INSERT INTO `tools_gen_table` VALUES (91, 'default', 'demo_gen', '代码生成测试表', 'DemoGen', 'crud', 'internal/app/demo/n1/n2', 'n2', 'demo_gen', '代码生成测试', 'gfast', '', '2022-11-01 17:27:43', '2025-09-04 12:00:18', '', b'1', 'id', 'asc', b'1', b'1', b'0', b'0', b'1', '[{\"key\": \"api\", \"value\": true}, {\"key\": \"controller\", \"value\": true}, {\"key\": \"dao\", \"value\": true}, {\"key\": \"dao_internal\", \"value\": true}, {\"key\": \"logic\", \"value\": true}, {\"key\": \"model\", \"value\": true}, {\"key\": \"model_do\", \"value\": true}, {\"key\": \"model_entity\", \"value\": true}, {\"key\": \"router\", \"value\": true}, {\"key\": \"router_func\", \"value\": true}, {\"key\": \"service\", \"value\": true}, {\"key\": \"sql\", \"value\": true}, {\"key\": \"tsApi\", \"value\": true}, {\"key\": \"tsModel\", \"value\": true}, {\"key\": \"vue\", \"value\": true}, {\"key\": \"vueDetail\", \"value\": true}, {\"key\": \"vueEdit\", \"value\": true}]', 0, NULL);
INSERT INTO `tools_gen_table` VALUES (92, 'default', 'demo_gen_class', '代码生成关联测试表', 'DemoGenClass', 'crud', 'internal/app/demo/n1/n2', 'n2', 'demo_gen_class', '分类信息', 'gfast', '', '2022-11-03 06:36:57', '2025-08-14 11:59:23', '分类', b'1', 'id', 'asc', b'1', b'1', b'0', b'0', b'1', '[{\"key\": \"api\", \"value\": true}, {\"key\": \"controller\", \"value\": true}, {\"key\": \"dao\", \"value\": true}, {\"key\": \"dao_internal\", \"value\": true}, {\"key\": \"logic\", \"value\": true}, {\"key\": \"model\", \"value\": true}, {\"key\": \"model_do\", \"value\": true}, {\"key\": \"model_entity\", \"value\": true}, {\"key\": \"router\", \"value\": true}, {\"key\": \"router_func\", \"value\": true}, {\"key\": \"service\", \"value\": true}, {\"key\": \"sql\", \"value\": false}, {\"key\": \"tsApi\", \"value\": true}, {\"key\": \"tsModel\", \"value\": true}, {\"key\": \"vue\", \"value\": true}, {\"key\": \"vueDetail\", \"value\": true}, {\"key\": \"vueEdit\", \"value\": true}]', 0, NULL);
INSERT INTO `tools_gen_table` VALUES (93, 'default', 'demo_gen_tree', '代码生成树形结构测试表', 'DemoGenTree', 'tree', 'internal/app/demo/n1/n2', 'n2', 'demo_gen_tree', '代码生成树形结构测试', 'gfast', '{\"treeCode\":\"id\",\"treeName\":\"demoName\",\"treeParentCode\":\"parentId\"}', '2022-11-29 15:11:34', '2025-09-04 15:49:29', '', b'1', 'id', 'asc', b'1', b'0', b'0', b'1', b'0', '[{\"key\": \"api\", \"value\": true}, {\"key\": \"controller\", \"value\": true}, {\"key\": \"dao\", \"value\": true}, {\"key\": \"dao_internal\", \"value\": true}, {\"key\": \"logic\", \"value\": true}, {\"key\": \"model\", \"value\": true}, {\"key\": \"model_do\", \"value\": true}, {\"key\": \"model_entity\", \"value\": true}, {\"key\": \"router\", \"value\": true}, {\"key\": \"router_func\", \"value\": true}, {\"key\": \"service\", \"value\": true}, {\"key\": \"sql\", \"value\": false}, {\"key\": \"tsApi\", \"value\": true}, {\"key\": \"tsModel\", \"value\": true}, {\"key\": \"vue\", \"value\": true}, {\"key\": \"vueDetail\", \"value\": true}, {\"key\": \"vueEdit\", \"value\": true}]', 0, NULL);
INSERT INTO `tools_gen_table` VALUES (94, 'default', 'demo_data_auth', '数据权限测试', 'DemoDataAuth', 'crud', 'internal/app/demo', 'demo', 'demo_data_auth', '数据权限测试', 'gfast', '', '2023-02-12 11:18:42', '2024-03-18 10:18:00', '', b'1', 'id', 'asc', b'0', b'0', b'0', b'0', b'0', '[{\"key\": \"api\", \"value\": true}, {\"key\": \"controller\", \"value\": true}, {\"key\": \"dao\", \"value\": true}, {\"key\": \"dao_internal\", \"value\": true}, {\"key\": \"logic\", \"value\": true}, {\"key\": \"model\", \"value\": true}, {\"key\": \"model_do\", \"value\": true}, {\"key\": \"model_entity\", \"value\": true}, {\"key\": \"router\", \"value\": true}, {\"key\": \"router_func\", \"value\": true}, {\"key\": \"service\", \"value\": true}, {\"key\": \"sql\", \"value\": true}, {\"key\": \"tsApi\", \"value\": true}, {\"key\": \"tsModel\", \"value\": true}, {\"key\": \"vue\", \"value\": true}, {\"key\": \"vueDetail\", \"value\": true}, {\"key\": \"vueEdit\", \"value\": true}]', 0, NULL);
INSERT INTO `tools_gen_table` VALUES (95, 'default', 'demo_snow_id', '雪花ID测试', 'DemoSnowId', 'crud', 'internal/app/demo', 'demo', 'demo_snow_id', '雪花ID测试', 'gfast', '', '2023-09-19 15:34:46', '2024-12-19 16:57:58', '', b'1', 'id', 'asc', b'1', b'1', b'1', b'0', b'0', '[{\"key\": \"api\", \"value\": true}, {\"key\": \"controller\", \"value\": true}, {\"key\": \"dao\", \"value\": true}, {\"key\": \"dao_internal\", \"value\": true}, {\"key\": \"logic\", \"value\": true}, {\"key\": \"model\", \"value\": true}, {\"key\": \"model_do\", \"value\": true}, {\"key\": \"model_entity\", \"value\": true}, {\"key\": \"router\", \"value\": true}, {\"key\": \"router_func\", \"value\": true}, {\"key\": \"service\", \"value\": true}, {\"key\": \"sql\", \"value\": true}, {\"key\": \"tsApi\", \"value\": true}, {\"key\": \"tsModel\", \"value\": true}, {\"key\": \"vue\", \"value\": true}, {\"key\": \"vueDetail\", \"value\": true}, {\"key\": \"vueEdit\", \"value\": true}]', 0, NULL);
INSERT INTO `tools_gen_table` VALUES (96, 'default', 'demo_city_code', '省市区县和天气预报编码', 'DemoCityCode', 'tree', 'internal/app/demo', 'demo', 'demo_city_code', '省市区县', 'gfast', '{\"treeCode\":\"id\",\"treeName\":\"name\",\"treeParentCode\":\"pid\"}', '2023-11-02 10:38:51', '2024-04-07 09:30:57', '', b'1', 'id', 'asc', b'1', b'0', b'0', b'1', b'0', '[{\"key\": \"api\", \"value\": true}, {\"key\": \"controller\", \"value\": true}, {\"key\": \"dao\", \"value\": true}, {\"key\": \"dao_internal\", \"value\": true}, {\"key\": \"logic\", \"value\": true}, {\"key\": \"model\", \"value\": true}, {\"key\": \"model_do\", \"value\": true}, {\"key\": \"model_entity\", \"value\": true}, {\"key\": \"router\", \"value\": true}, {\"key\": \"router_func\", \"value\": true}, {\"key\": \"service\", \"value\": true}, {\"key\": \"sql\", \"value\": true}, {\"key\": \"tsApi\", \"value\": true}, {\"key\": \"tsModel\", \"value\": true}, {\"key\": \"vue\", \"value\": true}, {\"key\": \"vueDetail\", \"value\": true}, {\"key\": \"vueEdit\", \"value\": true}]', 0, NULL);
INSERT INTO `tools_gen_table` VALUES (97, 'default', 'product_category', '商品分类表', 'ProductCategory', 'tree', 'internal/app/demo', 'demo', 'product_category', '商品分类表', 'gfast', '{\"treeCode\":\"categoryId\",\"treeName\":\"categoryName\",\"treeParentCode\":\"parentId\"}', '2024-04-07 09:08:30', '2024-04-07 10:08:26', '', b'1', 'category_id', 'asc', b'0', b'0', b'0', b'1', b'0', '[{\"key\": \"api\", \"value\": true}, {\"key\": \"controller\", \"value\": true}, {\"key\": \"dao\", \"value\": true}, {\"key\": \"dao_internal\", \"value\": true}, {\"key\": \"logic\", \"value\": true}, {\"key\": \"model\", \"value\": true}, {\"key\": \"model_do\", \"value\": true}, {\"key\": \"model_entity\", \"value\": true}, {\"key\": \"router\", \"value\": true}, {\"key\": \"router_func\", \"value\": true}, {\"key\": \"service\", \"value\": true}, {\"key\": \"sql\", \"value\": true}, {\"key\": \"tsApi\", \"value\": true}, {\"key\": \"tsModel\", \"value\": true}, {\"key\": \"vue\", \"value\": true}, {\"key\": \"vueDetail\", \"value\": true}, {\"key\": \"vueEdit\", \"value\": true}]', 0, NULL);
INSERT INTO `tools_gen_table` VALUES (98, 'default', 'demo_gen_other', '特殊字段测试', 'DemoGenOther', 'crud', 'internal/app/system', 'system', 'demo_gen_other', '特殊字段测试', 'gfast', '', '2024-07-22 15:26:47', '2024-07-22 15:26:47', '', b'0', 'id', 'asc', b'0', b'0', b'0', b'0', b'0', 'null', 0, NULL);
INSERT INTO `tools_gen_table` VALUES (112, 'default', 'lm_config', '大模型相关配置数据表', 'LmConfig', 'crud', 'internal/app/llvm', 'llvm', 'lm_config', '大模型相关配置数据表', 'gfast', '', '2025-04-28 15:15:01', '2025-04-28 15:31:04', '', b'1', 'id', 'asc', b'1', b'0', b'0', b'0', b'0', '[{\"key\": \"api\", \"value\": true}, {\"key\": \"controller\", \"value\": true}, {\"key\": \"dao\", \"value\": true}, {\"key\": \"dao_internal\", \"value\": true}, {\"key\": \"logic\", \"value\": true}, {\"key\": \"model\", \"value\": true}, {\"key\": \"model_do\", \"value\": true}, {\"key\": \"model_entity\", \"value\": true}, {\"key\": \"router\", \"value\": true}, {\"key\": \"router_func\", \"value\": true}, {\"key\": \"service\", \"value\": true}, {\"key\": \"sql\", \"value\": true}, {\"key\": \"tsApi\", \"value\": true}, {\"key\": \"tsModel\", \"value\": true}, {\"key\": \"vue\", \"value\": true}, {\"key\": \"vueDetail\", \"value\": true}, {\"key\": \"vueEdit\", \"value\": true}]', 0, NULL);
...
CREATE TABLE `tools_gen_table_column`  (
  ...
  `sort_order_edit` int NULL DEFAULT 999 COMMENT '插入编辑显示顺序',
  `sort_order_list` int NULL DEFAULT 999 COMMENT '列表显示顺序',
  `sort_order_detail` int NULL DEFAULT 999 COMMENT '详情显示顺序',
  `sort_order_query` int NULL DEFAULT 999 COMMENT '查询显示顺序',
  ...
  `col_span` int NULL DEFAULT 12 COMMENT '详情页占列数',
  `row_span` int NULL DEFAULT 1 COMMENT '详情页占行数',
  `is_row_start` bit(1) NULL DEFAULT b'0' COMMENT '详情页为行首',
  `min_width` int NULL DEFAULT 100 COMMENT '表格最小宽度',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1133 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '代码生成业务表字段' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `tools_gen_table_column` VALUES (947, 91, 'classes', '班级', 'varchar(30)', 'string', 'string', 'Classes', 'classes', b'0', b'0', b'0', b'1', b'1', b'1', b'1', 4, 4, 4, 4, 'EQ', 'radio', '', 'demo_gen_class', 'DemoGenClass', 'n2', 'demo_gen_class', 'internal/app/demo/n1/n2', 'id', 'class_name', 1, 1, b'0', 100, b'0', b'0', b'0', '', '');
...
INSERT INTO `tools_gen_table_column` VALUES (967, 93, 'classes', '班级', 'varchar(30)', 'string', 'string', 'Classes', 'classes', b'0', b'0', b'0', b'1', b'1', b'1', b'1', 5, 5, 5, 5, 'EQ', 'select', '', 'demo_gen_class', 'DemoGenClass', 'n2', 'demo_gen_class', 'internal/app/demo/n1/n2', 'id', 'class_name', 1, 1, b'0', 100, b'0', b'0', b'0', '', '');
...
INSERT INTO `tools_gen_table_column` VALUES (977, 91, 'classes_two', '班级2', 'varchar(30)', 'string', 'string', 'ClassesTwo', 'classesTwo', b'0', b'0', b'0', b'1', b'1', b'1', b'1', 4, 4, 4, 4, 'EQ', 'checkbox', '', 'demo_gen_class', 'DemoGenClass', 'n2', 'demo_gen_class', 'internal/app/demo/n1/n2', 'id', 'class_name', 1, 1, b'0', 100, b'0', b'0', b'0', '', '');
...
INSERT INTO `tools_gen_table_column` VALUES (994, 91, 'cate_trees', '树型结构', 'varchar(10)', 'uint', 'number', 'CateTrees', 'cateTrees', b'0', b'0', b'0', b'1', b'0', b'1', b'1', 19, 19, 19, 19, 'EQ', 'treeSelect', '', 'demo_gen_tree', 'DemoGenTree', 'n2', 'demo_gen_tree', 'internal/app/demo/n1/n2', 'id', 'demo_name', 1, 1, b'0', 100, b'0', b'0', b'0', '', '');
INSERT INTO `tools_gen_table_column` VALUES (995, 91, 'cate_trees_two', '树形多选', 'varchar(255)', 'string', 'string', 'CateTreesTwo', 'cateTreesTwo', b'0', b'0', b'0', b'1', b'1', b'1', b'1', 20, 20, 20, 20, 'EQ', 'treeSelects', '', 'demo_gen_tree', 'DemoGenTree', 'n2', 'demo_gen_tree', 'internal/app/demo/n1/n2', 'id', 'demo_name', 1, 1, b'0', 100, b'0', b'0', b'0', '', '');
...
INSERT INTO `tools_gen_table_column` VALUES (1036, 95, 'user_ids', '关联人信息', 'json', 'string', 'number[]', 'UserIds', 'userIds', b'0', b'0', b'0', b'1', b'1', b'1', b'1', 10, 10, 10, 10, 'EQ', 'userSelectorMultiple', '', '', '', '', '', '', '', '', 1, 1, b'0', 150, b'0', b'0', b'0', '', '');
...
INSERT INTO `tools_gen_table_column` VALUES (1038, 95, 'depart_ids', '关联部门信息', 'json', 'string', 'number[]', 'DepartIds', 'departIds', b'0', b'0', b'0', b'1', b'1', b'1', b'1', 12, 12, 12, 12, 'EQ', 'deptSelectorMultiple', '', '', '', '', '', '', '', '', 1, 1, b'0', 150, b'0', b'0', b'0', '', '');
...
INSERT INTO `tools_gen_table_column` VALUES (1124, 112, 'id', '主键ID', 'int(11)', 'int', 'number', 'Id', 'id', b'1', b'1', b'1', b'0', b'1', b'1', b'1', 1, 1, 1, 1, 'EQ', 'input', '', '', '', '', '', '', '', '', 1, 1, b'0', 150, b'0', b'0', b'0', '', '');
INSERT INTO `tools_gen_table_column` VALUES (1125, 112, 'model_name', '模型名称', 'varchar(255)', 'string', 'string', 'ModelName', 'modelName', b'0', b'0', b'1', b'1', b'1', b'1', b'1', 2, 2, 2, 2, 'EQ', 'select', 'lm_model_name', '', '', '', '', '', '', '', 1, 1, b'0', 150, b'0', b'0', b'0', '', '');
INSERT INTO `tools_gen_table_column` VALUES (1126, 112, 'api_key', 'API密钥', 'varchar(255)', 'string', 'string', 'ApiKey', 'apiKey', b'0', b'0', b'0', b'1', b'1', b'1', b'1', 3, 3, 3, 3, 'EQ', 'input', '', '', '', '', '', '', '', '', 1, 1, b'0', 150, b'0', b'0', b'0', '', '');
INSERT INTO `tools_gen_table_column` VALUES (1127, 112, 'base_url', '基础URL', 'varchar(255)', 'string', 'string', 'BaseUrl', 'baseUrl', b'0', b'0', b'0', b'1', b'1', b'1', b'1', 4, 4, 4, 4, 'EQ', 'input', '', '', '', '', '', '', '', '', 1, 1, b'0', 150, b'0', b'0', b'0', '', '');
INSERT INTO `tools_gen_table_column` VALUES (1128, 112, 'created_at', '创建时间', 'timestamp', 'Time', 'string', 'CreatedAt', 'createdAt', b'0', b'0', b'0', b'0', b'1', b'1', b'1', 5, 5, 5, 5, 'EQ', 'datetime', '', '', '', '', '', '', '', '', 1, 1, b'0', 150, b'0', b'0', b'0', '', '');
INSERT INTO `tools_gen_table_column` VALUES (1129, 112, 'updated_at', '更新时间', 'timestamp', 'Time', 'string', 'UpdatedAt', 'updatedAt', b'0', b'0', b'0', b'0', b'0', b'0', b'0', 6, 6, 6, 6, 'EQ', 'datetime', '', '', '', '', '', '', '', '', 1, 1, b'0', 150, b'0', b'0', b'0', '', '');
INSERT INTO `tools_gen_table_column` VALUES (1130, 112, 'deleted_at', '删除时间', 'timestamp', 'Time', 'string', 'DeletedAt', 'deletedAt', b'0', b'0', b'0', b'0', b'0', b'0', b'0', 7, 7, 7, 7, 'EQ', 'datetime', '', '', '', '', '', '', '', '', 1, 1, b'0', 150, b'0', b'0', b'0', '', '');
INSERT INTO `tools_gen_table_column` VALUES (1131, 112, 'created_by', '创建者ID', 'int(11)', 'int', 'number', 'CreatedBy', 'createdBy', b'0', b'0', b'0', b'0', b'1', b'1', b'1', 8, 8, 8, 8, 'EQ', 'input', '', '', '', '', '', '', '', '', 1, 1, b'0', 150, b'0', b'0', b'0', '', '');
INSERT INTO `tools_gen_table_column` VALUES (1132, 112, 'updated_by', '更新者ID', 'int(11)', 'int', 'number', 'UpdatedBy', 'updatedBy', b'0', b'0', b'0', b'0', b'0', b'1', b'0', 9, 9, 9, 9, 'EQ', 'input', '', '', '', '', '', '', '', '', 1, 1, b'0', 150, b'0', b'0', b'0', '', '');
